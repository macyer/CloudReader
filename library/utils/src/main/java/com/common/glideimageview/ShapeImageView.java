package com.common.glideimageview;
...
public class ShapeImageView extends ImageView {
    ...
    public ShapeImageView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray array = context.obtainStyledAttributes(attrs, com.common.utils.R.styleable.ShapeImageViewStyle, defStyleAttr, 0);

        mBorderWidth = array.getDimensionPixelSize(com.common.utils.R.styleable.ShapeImageViewStyle_riv_border_width, 0);
        mBorderColor = array.getColor(com.common.utils.R.styleable.ShapeImageViewStyle_riv_border_color, DEFAULT_BORDER_COLOR);
        mPressedBorderWidth = array.getDimensionPixelSize(com.common.utils.R.styleable.ShapeImageViewStyle_riv_pressed_border_width, mBorderWidth);
        mPressedBorderColor = array.getColor(com.common.utils.R.styleable.ShapeImageViewStyle_riv_pressed_border_color, mBorderColor);
        mPressedMaskColor = array.getColor(com.common.utils.R.styleable.ShapeImageViewStyle_riv_pressed_mask_color, Color.TRANSPARENT);
        ...
        mPressedModeEnabled = array.getBoolean(com.common.utils.R.styleable.ShapeImageViewStyle_riv_pressed_mode_enabled, true);
        mIsCircle = array.getBoolean(com.common.utils.R.styleable.ShapeImageViewStyle_riv_is_circle, false);
        mCornerRadius = array.getDimensionPixelSize(com.common.utils.R.styleable.ShapeImageViewStyle_riv_corner_radius, 0);
        array.recycle();
    }

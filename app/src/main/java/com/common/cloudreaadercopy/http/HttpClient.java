package com.common.cloudreaadercopy.http;

import com.common.cloudreaadercopy.bean.FrontpageBean;
import com.common.cloudreaadercopy.bean.GankIoDataBean;
import com.common.cloudreaadercopy.bean.GankIoDayBean;
import com.common.cloudreaadercopy.bean.HotMovieBean;
import com.common.cloudreaadercopy.bean.MovieDetailBean;
import com.common.cloudreaadercopy.bean.book.BookBean;
import com.common.cloudreaadercopy.bean.book.BookDetailBean;
...
public interface HttpClient {
    ...
    class Builder {
        ...
        public static HttpClient getTingIoServer(){
            return HttpUtils.getInstance().getTingIoServer(HttpClient.class);
        }
        public static HttpClient getDoubanIoServer(){
            return HttpUtils.getInstance().getDoubanIoServer(HttpClient.class);
        }
    }
